...
{
    public class NivelEducativoRepository : RepositoryBase, INivelEducativoRepository
    {
        ...
        public async Task<Answer> Edit(tbNivelesEducativos obj)
        {
            ...
            SqlParameter[] sqlParameters = {
                ...
                new SqlParameter(){ParameterName= "@Niv_Descripcion", DbType = DbType.String, Value = obj.Niv_Descripcion},
                new SqlParameter(){ParameterName= "@Niv_EsActivo", DbType = DbType.String, Value = obj.Niv_EsActivo},
