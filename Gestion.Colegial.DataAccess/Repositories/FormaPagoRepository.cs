...
namespace Gestion.Colegial.DataAccess.Repositories
{
    public class FormaPagoRepository : RepositoryBase, IFormaPagoRepository
    {
        ...
        {
            const string sql = "PR_tbFormasPago_List";
        ...
        {
            const string sql = "PR_tbFormasPago_Find";
        ...
        {
            const string sql = "PR_tbFormasPago_Detail";
            SqlParameter[] sqlParameters = {
                new SqlParameter(){ParameterName= "@Fpa_Id", DbType = DbType.Int32, Value = id },
            };
        ...
        {
            const string sql = "PR_tbFormasPago_Insert";
            SqlParameter[] sqlParameters = {
        ...
        {
            const string sql = "PR_tbFormasPago_Update";
            SqlParameter[] sqlParameters = {
        ...
        {
            const string sql = "PR_tbFormasPago_Delete";
            SqlParameter[] sqlParameters = {
                new SqlParameter(){ParameterName= "@Fpa_Id", DbType = DbType.Int32, Value = id },
            };
        ...
        {
            const string sql = "PR_tbFormasPago_Dropdown";
