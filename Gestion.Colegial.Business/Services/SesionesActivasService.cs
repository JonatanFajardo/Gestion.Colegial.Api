...
{
    public class SesionesActivasService : ISesionesActivasService
    {
        private readonly ISesionesActivasRepository _r;
        public SesionesActivasService(ISesionesActivasRepository r) { _r = r; }
