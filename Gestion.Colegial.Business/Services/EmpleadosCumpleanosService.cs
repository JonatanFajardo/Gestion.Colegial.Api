...
{
    public class EmpleadosCumpleanosService : IEmpleadosCumpleanosService
    {
        private readonly IEmpleadosCumpleanosRepository _r;
        public EmpleadosCumpleanosService(IEmpleadosCumpleanosRepository r) { _r = r; }
        ...
        public Task<Answer> List(int? Mes) => Wrap(_r.List(Mes));
    }
}
