...
{
    public class PiramideMatriculaService : IPiramideMatriculaService
    {
        private readonly IPiramideMatriculaRepository _r;
        public PiramideMatriculaService(IPiramideMatriculaRepository r) { _r = r; }
        ...
        public Task<Answer> List(int Anio) => Wrap(_r.List(Anio));
    }
}
