...
{
    public class PendientesCobrarService : IPendientesCobrarService
    {
        private readonly IPendientesCobrarRepository _r;
        public PendientesCobrarService(IPendientesCobrarRepository r) { _r = r; }
