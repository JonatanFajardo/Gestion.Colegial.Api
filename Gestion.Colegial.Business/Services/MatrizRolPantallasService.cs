...
{
    public class MatrizRolPantallasService : IMatrizRolPantallasService
    {
        private readonly IMatrizRolPantallasRepository _r;
        public MatrizRolPantallasService(IMatrizRolPantallasRepository r) { _r = r; }
        ...
        public Task<Answer> Get() => Wrap(_r.Get());
    }
}
