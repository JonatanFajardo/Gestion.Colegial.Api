...
{
    public class PagosDelDiaService : IPagosDelDiaService
    {
        private readonly IPagosDelDiaRepository _r;
        public PagosDelDiaService(IPagosDelDiaRepository r) { _r = r; }
        ...
        public Task<Answer> List(DateTime Fecha) => Wrap(_r.List(Fecha));
    }
}
