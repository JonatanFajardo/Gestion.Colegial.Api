...
{
    public class AlumnosDirectorioService : IAlumnosDirectorioService
    {
        private readonly IAlumnosDirectorioRepository _r;
        public AlumnosDirectorioService(IAlumnosDirectorioRepository r) { _r = r; }
        ...
        public Task<Answer> List(int? Cur_Id, int? Sec_Id) => Wrap(_r.List(Cur_Id, Sec_Id));
    }
}
