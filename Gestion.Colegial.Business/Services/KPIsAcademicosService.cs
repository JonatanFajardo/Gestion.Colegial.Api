...
{
    public class KPIsAcademicosService : IKPIsAcademicosService
    {
        private readonly IKPIsAcademicosRepository _r;
        public KPIsAcademicosService(IKPIsAcademicosRepository r) { _r = r; }
        ...
        public Task<Answer> Find(int Anio) => Wrap(_r.Find(Anio));
    }
}
