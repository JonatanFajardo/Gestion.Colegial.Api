...
namespace Gestion.Colegial.Business.Services
{
    public class TarifaService : ITarifaService
    {
        ...
        public async Task<Answer> GetByConceptoAndNivel(int conceptoId, int nivelId, int anio) => await ExecuteRepositoryMethod(() => _repository.GetByConceptoAndNivel(conceptoId, nivelId, anio));
