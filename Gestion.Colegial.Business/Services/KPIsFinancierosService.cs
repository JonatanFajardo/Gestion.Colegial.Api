...
{
    public class KPIsFinancierosService : IKPIsFinancierosService
    {
        private readonly IKPIsFinancierosRepository _r;
        public KPIsFinancierosService(IKPIsFinancierosRepository r) { _r = r; }
        ...
        public Task<Answer> Find(int Anio, int? Mes) => Wrap(_r.Find(Anio, Mes));
    }
}
