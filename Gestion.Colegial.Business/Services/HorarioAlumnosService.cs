...
{
    public class HorarioAlumnosService : IHorarioAlumnosService
    {
        private readonly IHorarioAlumnoRepository _repository;

        public HorarioAlumnosService(IHorarioAlumnoRepository repository)
        {
