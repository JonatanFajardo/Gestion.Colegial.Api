...
{
    public class CursoNivelService : ICursoNivelService
    {
        private readonly ICursoNivelRepository _repository;

        public CursoNivelService(ICursoNivelRepository repository)
        {
