...
namespace Gestion.Colegial.Api.Controllers
{
    ...
    {
        private readonly INivelEducativoService _nivelEducativoService;

        public NivelesEducativosController(INivelEducativoService nivelEducativoService)
        {
        ...
        {
            Answer answer = await _nivelEducativoService.NivelesEducativosDropdown();
            return Ok(answer.Data);
        }
